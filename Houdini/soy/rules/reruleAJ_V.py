...
def funcReplace(line):
    ...
    items = ['pet.1Angle','pet.2Angle','mid-ifAngle','Left_angle','Right_angle','Middle_angle','internode','pet.1','pet.2','lat1L','lat1W','lat2L','lat2W','midL','midW']
    funcFile = open("/sd0/plantsinsilico/plant/rules/V_polynomials.txt", 'r')
    funcList = []
